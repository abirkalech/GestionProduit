...
public class DetailProduitController implements Initializable {
    ...
    private void accueilfromdetail(ActionEvent event) throws IOException {
        ...
        loader.setLocation(getClass().getResource("/edu/EcoSystem/GUI/Profile.fxml"));
    ...
    void ShowEvent(int id) {
        ...
        try {
            ...
            Image image= new Image("file:C:/Users/Abir/Documents/NetBeansProjects/EcoSystem/build/classes/Image/"+newProduit.getImage());
