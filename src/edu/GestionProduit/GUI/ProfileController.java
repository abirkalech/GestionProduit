    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (produit2 d : data) {
            ...
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/EcoSystem/GUI/DivProduit.fxml"));
...
/*
    ...
    */
    ...
    private void testadmin(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/edu/EcoSystem/GUI/GestionProduit.fxml"));
    ...
    private void detailproduit(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/edu/EcoSystem/GUI/DetailProduit.fxml"));
        Parent profileParent = loader.load();
