...
public class DivProduitController implements Initializable {
    ...
    public void LoadValues(produit2 e) throws IOException {
        ...
        Image imageURI2 = new Image("file:C:/Users/Abir/Documents/NetBeansProjects/EcoSystem/build/classes/Image/" + e.getImage());
    ...
    public void doubleclick(MouseEvent event, produit2 selectedetab) throws SQLException {
        if (event.getClickCount() == 2) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/EcoSystem/GUI/DetailProduit.fxml"));
